...
if submit:
    ...
    if not is_valid_email(normalized_email):
        ...
        if success:
            ...
            if smtp_config:
                sent, _ = send_password_changed_notification(normalized_email, smtp_config)
                if sent:
...
st.caption("Need a temporary password first? Open the Forgot Password page in the sidebar.")